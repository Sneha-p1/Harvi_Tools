...
const About = () => {
  return (
    <div className="about-container bg-cover bg-center text-black" style={{ minHeight: "100vh" }}>
      {/* Hero Section */}
      <div className="relative bg-black text-white min-h-screen flex items-center justify-center px-8 overflow-hidden">
        ...
        <div className="absolute w-full h-full flex justify-end ml-[35%] mt-[25%]">
          <div className="w-3/5 ">
            <ImageSlider />
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative mt-8 flex flex-col md:flex-row items-center">
            <div className="relative w-full md:w-3/5">
              <img src={aboutimg} alt="Working Culture" className="rounded-lg shadow-lg" />
            </div>
            <div className="w-full md:w-2/5 bg-gray-900 text-white p-6 md:absolute md:right-0 md:top-1/4 md:translate-x-12 rounded-lg shadow-lg">
              ...
              <p className="text-sm mt-2 text-gray-300">
                At HARVI TOOLS, we specialize in creating high-quality plastic injection moulds and press tools. With a
                focus on precision and reliability, we provide customized solutions for various industries. Our advanced
                tools and skilled team ensure top-quality products that meet industry standards. We are committed to
                understanding customer needs and delivering beyond expectations.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gray-100 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-6 text-lg text-gray-700">
            At HARVI TOOLS, we specialize in the design and manufacturing of high-quality plastic injection moulds and
            press tools. With a proven track record of delivering precision-engineered products, we cater to a wide
            range of industries, ensuring customized solutions tailored to your specific needs.
          </p>
          <p className="mt-6 text-lg text-gray-700">
            Our advanced toolroom is equipped with cutting-edge technology, including EDM machines and a range of
            conventional machinery, enabling us to achieve unparalleled precision and quality.
          </p>
        </div>
      </div>
