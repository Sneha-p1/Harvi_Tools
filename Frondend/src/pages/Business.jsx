...
const Business = () => {
  return (
    <div className="min-h-screen bg-black py-12 px-6">
      {/* Header */}
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold uppercase text-yellow-400">Services</h1>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
          <div className="bg-black/60 backdrop-blur-lg rounded-xl shadow-lg p-8 hover:shadow-xl transition duration-300 border border-yellow-400/20">
            <h2 className="text-3xl font-semibold mb-4 flex items-center text-yellow-400">
              <FaCompass className="mr-3 text-white" /> Our Journey
            </h2>
            ...
            <h3 className="text-2xl font-semibold mt-8 text-yellow-400">
              Our Mission
            </h3>
            <ul className="space-y-4 mt-4">
              <li className="flex items-start text-gray-300">
                <FaCheckCircle className="mr-3 mt-1" />
                <div>
                  <strong>Highest Quality:</strong> Delivering top-notch
                  products that meet industry standards.
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
          <div className="grid grid-cols-2 gap-6">
            <img
              src={PlasticMould1}
              alt="Plastic Mould 1"
              className="rounded-lg shadow-lg h-[300px] w-full object-cover hover:scale-105 transition-transform duration-300"
            />
            <img
              src={PlasticMould2}
              alt="Plastic Mould 2"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1 bg-black/60 backdrop-blur-lg rounded-xl shadow-lg p-8 hover:shadow-xl transition duration-300 border border-yellow-400/20">
            <h2 className="text-3xl font-semibold mb-4 text-yellow-400">
              Milling Work
            </h2>
            <ul className="list-disc pl-6 space-y-2 text-gray-300">
