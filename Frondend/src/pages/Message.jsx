...
=======
        <div className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 bg-black">
            <div className="w-full max-w-6xl">
                ...
                <h1 className="text-3xl sm:text-4xl font-extrabold text-yellow-400 mb-6 text-center">
                    Messages
                </h1>

                <div className="bg-black/60 backdrop-blur-lg rounded-xl shadow-lg hover:shadow-xl transition duration-300 border border-yellow-400/20 p-6 sm:p-8">
                    <div className="overflow-x-auto">
                        <table className="min-w-full bg-black/60 backdrop-blur-lg rounded-lg">
                            <thead className="bg-yellow-400/10 text-yellow-400 text-xs sm:text-sm">
                                <tr>
                                    <th className="py-2 px-4 sm:py-3 sm:px-6 text-left font-semibold">
                                        Name
                                    </th>
                                    <th className="py-2 px-4 sm:py-3 sm:px-6 text-left font-semibold">
                                        Email
